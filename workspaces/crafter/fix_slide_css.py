...
# Extract background-image data URIs from old CSS
...
.cover h1{{font-size:32px;font-weight:700;color:#333;line-height:1.3;margin-bottom:8px}}
.cover .sub{{font-size:17px;color:#666;margin-bottom:28px;line-height:1.5}}
.cover .meta{{font-size:13px;color:#888;line-height:1.8}}
.content-slide{{background:url('{content_bg}') center/cover no-repeat;padding:0;overflow:hidden}}
.content-slide .s-header{{height:56px;display:flex;align-items:center;padding-left:40px}}
.content-slide .s-title{{font-size:22px;font-weight:700;color:#CC0000;margin:0;padding-left:2em}}
.content-slide .s-body{{padding:8px 40px 16px 40px;flex:1;overflow:hidden}}
...
.slide p{{font-size:13px;line-height:1.7;color:#444;margin-bottom:6px}}
.slide li{{font-size:13px;line-height:1.7;color:#444;margin-bottom:2px}}
...
.box h4{{font-size:13px;font-weight:700;margin-bottom:4px;color:#222}}
.box p{{font-size:12px;margin-bottom:2px;color:#333;line-height:1.6}}
...
th{{text-align:left;padding:6px 10px;background:#f0f0f0;color:#555;font-size:11px;font-weight:600;border-bottom:2px solid #CC0000}}
td{{padding:6px 10px;border-bottom:1px solid #eee;font-size:12px;color:#333}}
...
.d-section-title{{font-size:10px;color:#888;font-weight:700;margin-bottom:6px;text-transform:uppercase;letter-spacing:1px}}
.d-node{{display:inline-flex;align-items:center;gap:4px;padding:6px 12px;border-radius:6px;font-size:11px;font-weight:600;margin:3px;word-break:keep-all}}
...
.vs-col h4{{font-size:13px;font-weight:700;margin-bottom:6px}}
.vs-col.bad h4{{color:#C62828}}
.vs-col.good h4{{color:#2E7D32}}
.vs-col li{{font-size:12px;line-height:1.7;list-style:none;padding-left:16px;position:relative}}
...
.metric-strip .m-val{{font-size:24px;font-weight:900;line-height:1}}
