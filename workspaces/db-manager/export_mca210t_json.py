"""MCA210T 1년치 JSON 추출 — export API 사용 (페이징 없음)"""
...
FROM_DT = "2016-04-09"
TO_DT   = "2026-04-09"
OUTPUT  = r"C:\MES\wta-agents\reports\김근형\MCA210T_발주현황_10년.json"
...
def export(token):
    url = f"{API_BASE}/api/erp/purchase/mca210t/export?fr_dt={FROM_DT}&to_dt={TO_DT}"
...
if __name__ == "__main__":
    print(f"MCA210T export ({FROM_DT} ~ {TO_DT})")
    token = get_token()
    print("로그인 성공, 조회 중...")
    result = export(token)
